...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $b_detail = isset($_POST['b_detail']) ? trim($_POST['b_detail']) : '';
    ...
    <div class='tick-box tick-success'>
        ...
        <p class='tick-message text-success'>Bank Transaction Added Successfully!</p>
    </div>
    <script>
        setTimeout(() => {
            window.location.href = 'Bankdebit.php';
        }, 1500);
    </script>
</div>";
    } else {
...
<div class="container my-5">
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-header text-center">
            <h3 class="fw-bold"><i class="bi bi-bank me-2"></i> Bank Transactions</h3>
            <p class="text-muted">Please fill in the details below to record a bank transactions</p>
        </div>
        <div class="card-body p-4">
            <form method="POST" class="row g-3 needs-validation" novalidate>
                <!-- Bank Detail -->
                <div class="col-md-12">
                    <label for="b_detail" class="form-label"><strong>Transaction Type</strong></label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="bi bi-arrow-left-right"></i></span>
                        <select class="form-select" id="b_detail" name="b_detail" required>
                            <option value="" disabled selected>Select Transaction Type</option>
                            <option value="Debit">Debit</option>
                            <option value="Credit">Credit</option>
                            <option value="Interest">Interest</option>
                        </select>
                        <div class="invalid-feedback">Please choose a transaction type.</div>
                    </div>
                </div>

                <!-- Amount -->
                <div class="col-md-12">
                    <label for="ammount" class="form-label"><strong>Amount</strong></label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="bi bi-currency-rupee"></i></span>
                        <input type="number" class="form-control" id="ammount" name="ammount" placeholder="Enter amount" required>
                ...
                <!-- Date -->
                <div class="col-md-12">
                    <label for="b_date" class="form-label"><strong>Date</strong></label>
                    <div class="input-group">
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <a href="Showbank.php" class="btn btn-info px-4">
