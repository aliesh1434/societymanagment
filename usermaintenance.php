...
<head>
    <meta charset="UTF-8">
    <title>SDS | Maintenance Record</title>
...
<div class="container mt-4">
    <h3 class="text-center mb-4">
        <i class="bi bi-tools"></i> Your Maintenance Record
    </h3>
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<div class="alert alert-warning text-center">No maintenance records found for your house.</div>';
    }
